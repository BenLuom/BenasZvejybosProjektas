...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
                            ...
                            <div class="p-6 text-gray-900 dark:text-gray-100">
                                <form method="POST" action="{{ route('categories.store') }}">
                                    ...
                                    <form action="/action_page.php" method="post">
                                        <input type="date" id="date" value="<?php if(isset($_POST['date'])) echo $_POST['date']; ?>" name="date">
                                    </form>
                                    </body>
                                    </html>
                                    <form id="L" method="post">
                                        Valandos pasirinkimas:
                                        <br />
        ...
        <script>
        let resultRes = document.querySelector(".results");
        resultRes.style.display = "none";
        function showResults()
        {
            resultRes.style.display = "block";
        }
        </script>
    </body>
</html>
